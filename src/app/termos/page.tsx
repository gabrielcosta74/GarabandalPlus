    ...
    <main className="min-h-screen bg-white">
      <div className="max-w-5xl mx-auto px-6 py-16 space-y-10">
        ...
        <section id="peregrinacoes" className="space-y-3 scroll-mt-24">
          <h2 className="text-xl font-semibold text-slate-900">3. Peregrinações e inscrições</h2>
          <ul className="list-disc pl-6 text-slate-600 leading-relaxed space-y-2">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">4. Quotas, doações e pagamentos</h2>
          <ul className="list-disc pl-6 text-slate-600 leading-relaxed space-y-2">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">5. Loja online</h2>
          <ul className="list-disc pl-6 text-slate-600 leading-relaxed space-y-2">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">6. Propriedade intelectual</h2>
          <p className="text-slate-600 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">7. Limitação de responsabilidade</h2>
          <p className="text-slate-600 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">8. Proteção de dados</h2>
          <p className="text-slate-600 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">9. Alterações aos Termos</h2>
          <p className="text-slate-600 leading-relaxed">
        ...
        <section className="space-y-3">
          <h2 className="text-xl font-semibold text-slate-900">10. Lei aplicável e foro</h2>
          <p className="text-slate-600 leading-relaxed">
