...
const CAT = 'profecias' as const;
const cfg = CATEGORIES[CAT];

export async function generateMetadata(): Promise<Metadata> {
  return {
    title: `${cfg.fr.label} de Garabandal`,
    description: cfg.fr.tagline,
    alternates: {
      canonical: `${APP_URL}/fr/${cfg.fr.slug}`,
      languages: {
...
export default async function Page() {
  return <CategoryIndexPage category={CAT} locale="fr" />;
}
