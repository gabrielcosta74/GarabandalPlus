        ...
        <VIPLayout>
            ...
            <div className="space-y-10 pb-24">
                <div className="mt-8 flex items-center gap-4">
                    ...
                    <h1 className="text-3xl font-serif font-bold text-white tracking-tight">Testemunhos Áudio</h1>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="bg-slate-900/50 border border-slate-800 rounded-3xl p-16 text-center animate-in fade-in zoom-in-95 duration-500">
                        ...
                        <p className="text-slate-400 max-w-md mx-auto leading-relaxed">De momento não existem áudios partilhados.</p>
                    </div>
                ) : (
