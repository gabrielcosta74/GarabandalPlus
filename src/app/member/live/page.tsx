                ...
                <div className="max-w-5xl mx-auto space-y-8">
                    ...
                    <div className="text-center space-y-4">
                        <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full border text-xs font-bold uppercase tracking-widest transition-colors ${playbackStatus === 'error' ? 'bg-red-500/10 border-red-500/20 text-red-500' :
                            ...
                            {playbackStatus === 'playing' ? 'Em Direto' :
                                playbackStatus === 'buffering' ? 'A Carregar...' :
                                    playbackStatus === 'error' ? 'Offline' : 'A Ligar...'}
                        </div>
                        <h1 className="text-3xl md:text-5xl font-serif text-white">Santuário de Garabandal</h1>
                        <p className="text-slate-400 max-w-xl mx-auto">
                            Acompanhe em tempo real as imagens da Igreja e da vila de San Sebastián de Garabandal.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-slate-900/50 border border-white/5 rounded-2xl p-6">
                            <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
                                <Info className="w-5 h-5 text-yellow-500" /> Sobre a Transmissão
                            </h3>
                            <p className="text-slate-400 text-sm leading-relaxed">
                                Esta transmissão é fornecida diretamente de San Sebastián de Garabandal.
                            </p>
                            <div className="mt-4 pt-4 border-t border-white/5 space-y-2">
                                <h4 className="text-sm font-bold text-white mb-2">Horário das Missas (Espanha)</h4>
                        ...
                        <div className="bg-slate-900/50 border border-white/5 rounded-2xl p-6 flex flex-col justify-center items-center text-center">
                            <p className="text-slate-500 text-sm mb-2">Fusos Horários</p>
                            ...
                            <div className="text-xs text-slate-600 mt-1">Hora Local em Garabandal</div>
                        </div>
                    </div>
