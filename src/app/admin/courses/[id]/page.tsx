...
export default function CourseEditor() {
    ...
    const handleSave = async () => {
        ...
        if (isNew) router.push(`/admin/courses/${courseId}`);
            ...
            <div className="bg-white border-b border-slate-200 sticky top-0 z-40 px-4 py-3 md:px-6 md:py-4 shadow-sm">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    <div className="flex items-center gap-3">
                        <Link href="/admin/courses" className="p-2 hover:bg-slate-100 rounded-lg transition-colors text-slate-500 shrink-0">
