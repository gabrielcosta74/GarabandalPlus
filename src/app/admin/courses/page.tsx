...
export default function AdminCoursesPage() {
    ...
    return (
        <div className="min-h-screen bg-slate-50/50 p-4 md:p-10 pb-20">
            ...
            {/* Toolbar */}
            <div className="max-w-7xl mx-auto mb-6 md:mb-8 bg-white p-3 md:p-4 rounded-2xl shadow-sm border border-slate-200 flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="max-w-7xl mx-auto">
                {loading ? (
                    ...
                    <div className="text-center py-24 bg-white rounded-3xl border border-dashed border-slate-300 p-4">
                        ...
                        <Link href="/admin/courses/new" className="text-primary font-bold hover:underline">
                            Começar Agora &rarr;
                        </Link>
                    </div>
                ) : (
                                    ...
                                    <div className="p-5">
                                        ...
                                        <div className="flex justify-between items-center pt-4 border-t border-slate-50">
                                            ...
                                            <div className="flex gap-2">
                                                <Link href={`/admin/courses/${course.id}`} className="text-sm font-bold text-slate-900 hover:text-blue-600">Editar</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
