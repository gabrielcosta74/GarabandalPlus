...
export const metadata: Metadata = {
  ...
  description:
    'Informação e meios para eliminar uma conta Garabandal Membros e os dados associados.',
  alternates: {
...
const deletionMail =
  'mailto:geral@apostoladodegarabandal.com?subject=Pedido%20de%20elimina%C3%A7%C3%A3o%20de%20conta%20e%20dados&body=Solicito%20a%20elimina%C3%A7%C3%A3o%20da%20minha%20conta%20Garabandal%20Membros.%0A%0AEmail%20da%20conta%3A%20';
      ...
      <div className="mx-auto max-w-3xl space-y-8 px-6 py-16">
        <header className="space-y-4">
          ...
          <p className="text-slate-600 leading-relaxed">
            Esta página aplica-se às contas utilizadas no website e na aplicação Garabandal
            Membros.
          </p>
        </header>
        ...
        <section className="space-y-3">
          ...
          <p className="text-slate-600 leading-relaxed">
            ...
            processo revoga imediatamente o acesso, elimina o progresso e a atividade da app e
            anonimiza o perfil.
          </p>
        </section>
