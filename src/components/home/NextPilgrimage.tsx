                        ...
                        <div className="flex flex-col md:flex-row min-h-[500px]">
                            ...
                            <div className="w-full md:w-1/2 p-8 md:p-14 flex flex-col justify-center bg-white relative">
                                ...
                                <p className="text-slate-500 leading-relaxed mb-8 line-clamp-3">
                                    {nextPilgrimage.description || "Junte-se a nós nesta experiência única de fé e devoção. Um programa completo pensado para o seu crescimento espiritual."}
                                </p>
                                ...
                                <div className="space-y-4 mb-10">
                                    <div className="flex items-center gap-4 text-slate-700">
                                        ...
                                        <div>
                                            <p className="font-bold text-sm uppercase tracking-wider text-slate-400">Roteiro</p>
                                    ...
                                    <div className="flex items-center gap-4 text-slate-700">
                                        ...
                                        <div>
                                            <p className="font-bold text-sm uppercase tracking-wider text-slate-400">Vagas</p>
                                            <p className="font-medium">Limitadas e exclusivas</p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col sm:flex-row gap-4 mt-auto">
                                    <Link
                                        href={`/peregrinacoes#${nextPilgrimage.slug}`}
