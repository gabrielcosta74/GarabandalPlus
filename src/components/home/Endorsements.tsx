...
const Endorsements = ({ locale }: { locale: 'pt' | 'en' }) => {
        ...
        <section className="bg-white py-24 md:py-32">
            <div className="container mx-auto max-w-7xl px-6">
                ...
                <div className="mb-14 max-w-3xl md:mb-16">
                    <span className="mb-5 inline-flex items-center gap-2 rounded-full border border-amber-200 bg-amber-50 px-3 py-1 text-xs font-bold uppercase tracking-widest text-amber-700">
                        {isEn ? 'Recognition' : 'Reconhecimento'}
                    </span>
                    <h2 className="mb-5 font-serif text-4xl leading-[1.1] tracking-tight text-slate-900 md:text-5xl lg:text-6xl">
                        {isEn ? (
