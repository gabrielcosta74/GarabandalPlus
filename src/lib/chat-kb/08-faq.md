...
**P: Posso inscrever outras pessoas além de mim?**
R: Sim. No formulário de inscrição pode adicionar vários peregrinos (família, amigos). Cada um tem de ter email próprio.

**P: Preciso de ser católico praticante?**
R: Não é obrigatório. Peregrinos de todos os caminhos de fé são bem-vindos — pedimos apenas respeito pelo espírito católico da peregrinação.

**P: Posso pagar a prestações?**
...
**P: Que tipo de quarto posso escolher?**
R: Individual (com suplemento), duplo ou triplo. É escolhido no passo de "Organização de quartos" durante a inscrição.

**P: Posso ficar num quarto sozinho?**
R: Sim, pagando o suplemento de quarto individual (valor indicado na inscrição).

**P: E se precisar de cancelar?**
...
**P: Que moeda posso usar para pagar?**
R: Euros (€). Aceitamos cartão, PIX (Brasil) e transferência bancária (Wise para internacional).

**P: Vão emitir recibo/fatura?**
R: Sim. Os pagamentos são registados e o recibo/fatura pode ser pedido a geral@apostoladodegarabandal.com

**P: Sou do Brasil / Angola / outro país. Posso participar?**
R: Sim, completamente. Temos peregrinos de vários países. O peregrino trata do seu voo até Lisboa (ponto de encontro) e do visto Schengen se aplicável.

**P: Preciso de seguro de viagem?**
R: Não está incluído mas é fortemente recomendado, incluindo cobertura de cancelamento.
